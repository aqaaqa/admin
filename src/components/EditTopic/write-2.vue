...
export default {
  ...
  methods: {
    partForm(val) {
      ...
      form.article = ''
      form.cor = ''
      for(let i in val.detail) {
        let e = val.detail[i]
        if(i == val.detail.length-1){
